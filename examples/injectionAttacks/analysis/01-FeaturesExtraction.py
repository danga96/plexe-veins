...
class FeaturesExtraction:
    ...
    def __init__(self, base_path, file_name):
        ...
        self.distances = FeaturesExtraction.__compute_min_max_distances(self.parameters, self.vectors)
    ...
    def __extract_parameters(data):
        _parameters = data[data.type.isin(["runattr", "param", "itervar"])] \
    ...
    def __compute_min_max_distances(parameters, vectors):
        ...
        _distances = _distances[_distances.repetition == 0]
        ...
        _columns = _index_columns + ["vehicle", "crashed"]
