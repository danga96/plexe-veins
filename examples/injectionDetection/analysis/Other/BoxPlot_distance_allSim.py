...
class InjectionDetectionAnalyzer:
    ...
    def get_distance_feature(self,attack,time_detect):
        ...
        """
        plt.plot(_sampling_times, _foll_data["RadarDistance"], label = "RadarDistance_Follow")
        plt.plot(_sampling_times, self._expected_distance, label = "RadarDistance_Time")
        plt.xlabel('x - axis')
        plt.ylabel('y - axis')
        plt.title('Two or more lines distance ')
        plt.legend()
        plt.show()
        exit()
        """
        ...
        #     value_distance = value_distance[:wh[0]+100]
...
if __name__ == "__main__":
    ...
    #EXPORT ORIGINAL
    #print(_features,type(_features))
    print("\n\n",df)
