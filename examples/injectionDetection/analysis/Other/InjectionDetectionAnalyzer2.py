...
class InjectionDetectionAnalyzer:
    ...
    def plot_detection_graph(self, title, ax=None, legend=True):
        ...
        if self.attack_start:
            ax.axvline(self.attack_start, color="black", linestyle=":", lw=1)
...
if __name__ == "__main__":
    ...
    base_path = "../InjectionDetectionData"
    scenario = "Constant"
    controller = "Test"
    ...
    detection_parameters = {
        ...
        "distanceKFThresholdFactor": 0.33,
        "distanceRadarThresholdFactor": 0.20,
        "distanceV2XKFThresholdFactor": 1,
        "distanceRadarKFThresholdFactor": 1.5,

        "speedV2XKFThresholdFactor": 1,
        "speedRadarV2XThresholdFactor": 1,
        "speedRadarKFThresholdFactor": 1,
    ...
    analyzers = {
        "NoAttack": InjectionDetectionAnalyzer(base_path, "{}NoAttack.csv".format(scenario), detection_parameters),
